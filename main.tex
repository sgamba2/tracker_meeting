...
\begin{frame}{Results}
  \begin{columns}
    \begin{column}{0.5\framewidth}
      $$x \ \text{coordinate distribution (panel frame)}$$

      \begin{figure}[H]
        \centering
        \includegraphics[width=0.8 \textwidth]{figures/pdf/x_panel0.pdf}
        \label{fig:enter-label}
    \end{figure}
    \end{column}
    \begin{column}{0.5\framewidth}
      $$x_{rec}-x_{true} \ \text{distribution (panel frame)}$$

      \begin{figure}[H]
        \centering
        \includegraphics[width=0.8 \textwidth]{figures/pdf/panel_00_x_bias.pdf}
        \label{fig:enter-label}
    \end{figure}
    \end{column}
  \end{columns}
